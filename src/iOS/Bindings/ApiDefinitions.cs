...
namespace Datadog.iOS
{
	...
	interface DDDatadog
	{
		...
		void SetUserInfo ([NullAllowed] string id, [NullAllowed] string name, [NullAllowed] string email, NSDictionary<NSString, NSObject> extraInfo);
...
#pragma warning restore CS0108
	...
	interface DDSessionReplayConfiguration
	{
		...
		// -(instancetype _Nonnull)initWithReplaySampleRate:(float)replaySampleRate textAndInputPrivacyLevel:(enum DDTextAndInputPrivacyLevel)textAndInputPrivacyLevel imagePrivacyLevel:(enum DDImagePrivacyLevel)imagePrivacyLevel touchPrivacyLevel:(enum DDTouchPrivacyLevel)touchPrivacyLevel __attribute__((objc_designated_initializer));
