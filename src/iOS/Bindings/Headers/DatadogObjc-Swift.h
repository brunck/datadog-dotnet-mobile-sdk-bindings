...
@class DDRUMAction;
SWIFT_PROTOCOL("_TtP11DatadogObjc28DDSwiftUIRUMActionsPredicate_")
@protocol DDSwiftUIRUMActionsPredicate
/// The predicate deciding if the RUM Action should be tracked or dropped.
/// \param componentName The name of the SwiftUI component that received the action
///
///
/// returns:
/// RUM Action if it should be tracked, <code>nil</code> otherwise.
- (DDRUMAction * _Nullable)rumActionWith:(NSString * _Nonnull)componentName SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC11DatadogObjc35DDDefaultSwiftUIRUMActionsPredicate")
@interface DDDefaultSwiftUIRUMActionsPredicate : NSObject <DDSwiftUIRUMActionsPredicate>
- (nonnull instancetype)initWithIsLegacyDetectionEnabled:(BOOL)isLegacyDetectionEnabled OBJC_DESIGNATED_INITIALIZER;
- (DDRUMAction * _Nullable)rumActionWith:(NSString * _Nonnull)componentName SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class DDRUMView;
SWIFT_PROTOCOL("_TtP11DatadogObjc26DDSwiftUIRUMViewsPredicate_")
...
/// \param extractedViewName The name of the SwiftUI view detected by the SDK.
///
///
/// returns:
/// RUM View parameters if the view should be tracked, <code>nil</code> otherwise.
- (DDRUMView * _Nullable)rumViewFor:(NSString * _Nonnull)extractedViewName SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC11DatadogObjc33DDDefaultSwiftUIRUMViewsPredicate")
...
@property (nonatomic, readonly, strong) DDLogEventAccountInfo * _Nonnull accountInfo;
...
SWIFT_CLASS("_TtC11DatadogObjc21DDLogEventAccountInfo")
...
@class DDRUMActionEventRUMAccount;
...
@property (nonatomic, readonly, strong) DDRUMActionEventRUMAccount * _Nullable account;
...
@property (nonatomic, readonly, copy) NSString * _Nullable ddtags;
...
@property (nonatomic, readonly, copy) NSString * _Nullable currentLocale;
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, strong) NSNumber * _Nullable profilingSampleRate;
...
SWIFT_CLASS("_TtC11DatadogObjc26DDRUMActionEventRUMAccount")
...
@property (nonatomic, readonly, strong) NSNumber * _Nullable brightnessLevel;
@property (nonatomic, readonly, copy) NSString * _Nullable locale;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable locales;
@property (nonatomic, readonly, copy) NSString * _Nullable model;
@property (nonatomic, readonly, copy) NSString * _Nullable name;
@property (nonatomic, readonly, strong) NSNumber * _Nullable powerSavingMode;
...
typedef SWIFT_ENUM(NSInteger, DDRUMActionEventRUMDeviceRUMDeviceType, open) {
  DDRUMActionEventRUMDeviceRUMDeviceTypeNone = 0,
  DDRUMActionEventRUMDeviceRUMDeviceTypeMobile = 1,
  DDRUMActionEventRUMDeviceRUMDeviceTypeDesktop = 2,
  DDRUMActionEventRUMDeviceRUMDeviceTypeTablet = 3,
  DDRUMActionEventRUMDeviceRUMDeviceTypeTv = 4,
  DDRUMActionEventRUMDeviceRUMDeviceTypeGamingConsole = 5,
  DDRUMActionEventRUMDeviceRUMDeviceTypeBot = 6,
  DDRUMActionEventRUMDeviceRUMDeviceTypeOther = 7,
};
...
@class DDRUMErrorEventRUMAccount;
...
typedef SWIFT_ENUM(NSInteger, DDRUMErrorEventErrorCategory, open) {
  ...
  DDRUMErrorEventErrorCategoryNetwork = 6,
};
...
SWIFT_CLASS("_TtC11DatadogObjc25DDRUMErrorEventRUMAccount")
...
typedef SWIFT_ENUM(NSInteger, DDRUMErrorEventRUMDeviceRUMDeviceType, open) {
  DDRUMErrorEventRUMDeviceRUMDeviceTypeNone = 0,
  DDRUMErrorEventRUMDeviceRUMDeviceTypeMobile = 1,
  DDRUMErrorEventRUMDeviceRUMDeviceTypeDesktop = 2,
  DDRUMErrorEventRUMDeviceRUMDeviceTypeTablet = 3,
  DDRUMErrorEventRUMDeviceRUMDeviceTypeTv = 4,
  DDRUMErrorEventRUMDeviceRUMDeviceTypeGamingConsole = 5,
  DDRUMErrorEventRUMDeviceRUMDeviceTypeBot = 6,
  DDRUMErrorEventRUMDeviceRUMDeviceTypeOther = 7,
};
...
@class DDRUMLongTaskEventRUMAccount;
...
@class DDRUMLongTaskEventDDProfiling;
...
@property (nonatomic, readonly, strong) NSNumber * _Nonnull formatVersion;
@property (nonatomic, readonly, strong) DDRUMLongTaskEventDDProfiling * _Nullable profiling;
@property (nonatomic, readonly, copy) NSString * _Nullable sdkName;
...
enum DDRUMLongTaskEventDDProfilingErrorReason : NSInteger;
enum DDRUMLongTaskEventDDProfilingStatus : NSInteger;
SWIFT_CLASS("_TtC11DatadogObjc29DDRUMLongTaskEventDDProfiling")
...
typedef SWIFT_ENUM(NSInteger, DDRUMLongTaskEventDDProfilingErrorReason, open) {
...
typedef SWIFT_ENUM(NSInteger, DDRUMLongTaskEventDDProfilingStatus, open) {
...
SWIFT_CLASS("_TtC11DatadogObjc28DDRUMLongTaskEventRUMAccount")
...
typedef SWIFT_ENUM(NSInteger, DDRUMLongTaskEventRUMDeviceRUMDeviceType, open) {
  DDRUMLongTaskEventRUMDeviceRUMDeviceTypeNone = 0,
  DDRUMLongTaskEventRUMDeviceRUMDeviceTypeMobile = 1,
  DDRUMLongTaskEventRUMDeviceRUMDeviceTypeDesktop = 2,
  DDRUMLongTaskEventRUMDeviceRUMDeviceTypeTablet = 3,
  DDRUMLongTaskEventRUMDeviceRUMDeviceTypeTv = 4,
  DDRUMLongTaskEventRUMDeviceRUMDeviceTypeGamingConsole = 5,
  DDRUMLongTaskEventRUMDeviceRUMDeviceTypeBot = 6,
  DDRUMLongTaskEventRUMDeviceRUMDeviceTypeOther = 7,
};
...
@class DDRUMResourceEventRUMAccount;
...
@property (nonatomic, readonly, strong) DDRUMResourceEventRUMAccount * _Nullable account;
...
@property (nonatomic, readonly, strong) NSNumber * _Nullable discarded;
@property (nonatomic, readonly, strong) NSNumber * _Nonnull formatVersion;
@property (nonatomic, readonly, copy) NSString * _Nullable parentSpanId;
...
SWIFT_CLASS("_TtC11DatadogObjc28DDRUMResourceEventRUMAccount")
...
typedef SWIFT_ENUM(NSInteger, DDRUMResourceEventRUMDeviceRUMDeviceType, open) {
  DDRUMResourceEventRUMDeviceRUMDeviceTypeNone = 0,
  DDRUMResourceEventRUMDeviceRUMDeviceTypeMobile = 1,
  DDRUMResourceEventRUMDeviceRUMDeviceTypeDesktop = 2,
  DDRUMResourceEventRUMDeviceRUMDeviceTypeTablet = 3,
  DDRUMResourceEventRUMDeviceRUMDeviceTypeTv = 4,
  DDRUMResourceEventRUMDeviceRUMDeviceTypeGamingConsole = 5,
  DDRUMResourceEventRUMDeviceRUMDeviceTypeBot = 6,
  DDRUMResourceEventRUMDeviceRUMDeviceTypeOther = 7,
};
...
@class DDRUMViewEventRUMAccount;
...
@property (nonatomic, readonly, strong) DDRUMViewEventRUMAccount * _Nullable account;
...
@class DDRUMViewEventDDProfiling;
...
@property (nonatomic, readonly, strong) DDRUMViewEventDDProfiling * _Nullable profiling;
...
enum DDRUMViewEventDDProfilingErrorReason : NSInteger;
enum DDRUMViewEventDDProfilingStatus : NSInteger;
SWIFT_CLASS("_TtC11DatadogObjc25DDRUMViewEventDDProfiling")
...
typedef SWIFT_ENUM(NSInteger, DDRUMViewEventDDProfilingErrorReason, open) {
...
typedef SWIFT_ENUM(NSInteger, DDRUMViewEventDDProfilingStatus, open) {
...
SWIFT_CLASS("_TtC11DatadogObjc24DDRUMViewEventRUMAccount")
...
typedef SWIFT_ENUM(NSInteger, DDRUMViewEventRUMDeviceRUMDeviceType, open) {
  DDRUMViewEventRUMDeviceRUMDeviceTypeNone = 0,
  DDRUMViewEventRUMDeviceRUMDeviceTypeMobile = 1,
  DDRUMViewEventRUMDeviceRUMDeviceTypeDesktop = 2,
  DDRUMViewEventRUMDeviceRUMDeviceTypeTablet = 3,
  DDRUMViewEventRUMDeviceRUMDeviceTypeTv = 4,
  DDRUMViewEventRUMDeviceRUMDeviceTypeGamingConsole = 5,
  DDRUMViewEventRUMDeviceRUMDeviceTypeBot = 6,
  DDRUMViewEventRUMDeviceRUMDeviceTypeOther = 7,
};
...
@class DDRUMViewEventViewAccessibility;
...
@property (nonatomic, readonly, strong) DDRUMViewEventViewAccessibility * _Nullable accessibility;
...
SWIFT_CLASS("_TtC11DatadogObjc31DDRUMViewEventViewAccessibility")
@interface DDRUMViewEventViewAccessibility : NSObject
@property (nonatomic, readonly, strong) NSNumber * _Nullable assistiveSwitchEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable assistiveTouchEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable boldTextEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable buttonShapesEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable closedCaptioningEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable grayscaleEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable increaseContrastEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable invertColorsEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable monoAudioEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable onOffSwitchLabelsEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable reduceMotionEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable reduceTransparencyEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable reducedAnimationsEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable screenReaderEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable shakeToUndoEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable shouldDifferentiateWithoutColor;
@property (nonatomic, readonly, strong) NSNumber * _Nullable singleAppModeEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable speakScreenEnabled;
@property (nonatomic, readonly, strong) NSNumber * _Nullable speakSelectionEnabled;
@property (nonatomic, readonly, copy) NSString * _Nullable textSize;
...
@class DDRUMVitalEventRUMAccount;
...
SWIFT_CLASS("_TtC11DatadogObjc25DDRUMVitalEventRUMAccount")
...
typedef SWIFT_ENUM(NSInteger, DDRUMVitalEventRUMDeviceRUMDeviceType, open) {
  DDRUMVitalEventRUMDeviceRUMDeviceTypeNone = 0,
  DDRUMVitalEventRUMDeviceRUMDeviceTypeMobile = 1,
  DDRUMVitalEventRUMDeviceRUMDeviceTypeDesktop = 2,
  DDRUMVitalEventRUMDeviceRUMDeviceTypeTablet = 3,
  DDRUMVitalEventRUMDeviceRUMDeviceTypeTv = 4,
  DDRUMVitalEventRUMDeviceRUMDeviceTypeGamingConsole = 5,
  DDRUMVitalEventRUMDeviceRUMDeviceTypeBot = 6,
  DDRUMVitalEventRUMDeviceRUMDeviceTypeOther = 7,
};
...
enum DDRUMVitalEventVitalFailureReason : NSInteger;
enum DDRUMVitalEventVitalStepType : NSInteger;
...
@property (nonatomic, readonly, strong) NSNumber * _Nullable duration;
@property (nonatomic, readonly) enum DDRUMVitalEventVitalFailureReason failureReason;
@property (nonatomic, readonly, copy) NSString * _Nonnull id;
@property (nonatomic, readonly, copy) NSString * _Nullable name;
@property (nonatomic, readonly, copy) NSString * _Nullable parentId;
@property (nonatomic, readonly) enum DDRUMVitalEventVitalStepType stepType;
@property (nonatomic, readonly) enum DDRUMVitalEventVitalVitalType type;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, DDRUMVitalEventVitalFailureReason, open) {
  DDRUMVitalEventVitalFailureReasonNone = 0,
  DDRUMVitalEventVitalFailureReasonError = 1,
  DDRUMVitalEventVitalFailureReasonAbandoned = 2,
  DDRUMVitalEventVitalFailureReasonOther = 3,
};

typedef SWIFT_ENUM(NSInteger, DDRUMVitalEventVitalStepType, open) {
  DDRUMVitalEventVitalStepTypeNone = 0,
  DDRUMVitalEventVitalStepTypeStart = 1,
  DDRUMVitalEventVitalStepTypeUpdate = 2,
  DDRUMVitalEventVitalStepTypeRetry = 3,
  DDRUMVitalEventVitalStepTypeEnd = 4,
};
...
+ (DDSite * _Nonnull)ap2 SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly, strong) NSNumber * _Nullable numberOfDisplays;
